    ...
    public class RegistroUsuario extends JFrame
    {
        ...
        private void initComponents()
        {
            ...
            //---- Carnet_Field ----
            Carnet_Field.setFont(new Font("Century Schoolbook", Font.PLAIN, 16));
            ...
            Carnet_Field.setBounds(30, 80, 190, 35);

            //---- Nombre_Field ----
            Nombre_Field.setFont(new Font("Century Schoolbook", Font.PLAIN, 16));
            ...
            Nombre_Field.setBounds(30, 140, 190, 35);

            //---- Apellido_Field ----
            Apellido_Field.setFont(new Font("Century Schoolbook", Font.PLAIN, 16));
            ...
            Apellido_Field.setBounds(30, 200, 190, 35);

            //---- Carrera_Field ----
            Carrera_Field.setFont(new Font("Century Schoolbook", Font.PLAIN, 16));
            ...
            Carrera_Field.setBounds(30, 265, 190, 35);

            //---- Contraseña_Field ----
            Contraseña_Field.setFont(new Font("Century Schoolbook", Font.PLAIN, 16));
            contentPane.add(Contraseña_Field);
            Contraseña_Field.setBounds(30, 325, 190, 35);
            ...
            label2.setBounds(new Rectangle(new Point(30, 120), label2.getPreferredSize()));
            ...
            label4.setBounds(new Rectangle(new Point(30, 240), label4.getPreferredSize()));

            //---- label5 ----
            label5.setText("Contrase\u00f1a");
            label5.setFont(new Font("Century Schoolbook", Font.PLAIN, 16));
            contentPane.add(label5);
            label5.setBounds(new Rectangle(new Point(30, 305), label5.getPreferredSize()));

            //---- Bt_Registrar ----
            Bt_Registrar.setText("Registrar");
            Bt_Registrar.setFont(new Font("Century Schoolbook", Font.PLAIN, 16));
            Bt_Registrar.addActionListener(e -> Bt_RegistrarActionPerformed(e));
            contentPane.add(Bt_Registrar);
            Bt_Registrar.setBounds(300, 125, 125, 40);

            //---- label6 ----
            label6.setText("REGISTRARSE");
            label6.setFont(new Font("Century Schoolbook", Font.PLAIN, 16));
            contentPane.add(label6);
            label6.setBounds(new Rectangle(new Point(160, 20), label6.getPreferredSize()));
            ...
            Bt_Regresar.setBounds(300, 195, 120, 40);
